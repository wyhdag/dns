...
o:value("218.203.59.116", translate("China Mobile DNS"))
o:value("202.97.224.68", translate("China Unicom DNS "))
o:value("219.147.198.230", translate("China Telecom DNS"))
